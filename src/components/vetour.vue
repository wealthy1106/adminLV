                                                ...
                                                <div class="modal-content">
                                                      ...
                                                      <div class="modal-body">
                                                            <div :key="index" v-for="(tt, index) in themLT ">
                                                                  <div>
                                                                        <label for="formGroupExampleInput">Giá người
                                                                              lớn</label>
                                                                        <input type="text" class="form-control"
                                                                              v-model="tt.nguoilon" id="formGroupExampleInput"
                                                                              placeholder="">
                                                                  </div>
                                                                  <div>
                                                                        <label for="formGroupExampleInput">Trẻ em</label>
                                                                        <input type="text" class="form-control"
                                                                              v-model="tt.tre10" id="formGroupExampleInput"
                                                                              placeholder="">
                                                                  </div>
                                                                  <div>
                                                                        <label for="formGroupExampleInput">idT</label>
                                                                        <input type="text" class="form-control"
                                                                  ...
                                                                  <div>
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                              v-model="tt.soluong" id="formGroupExampleInput"
                                                                              placeholder="">
                                                                  </div>
                                                            </div>
                                                      </div>
                                                            ...
                                                            <tr :key="index" v-for="(tt, index) in dsLT ">
                                                                  ...
                                                                  <td>
                                                                        <div class="d-flex align-items-center">
                                                                              ...
                                                                              <!-- Button trigger modal -->
                                                                              <button type="button" @click="chinhsua(tt.idV)"
                                                                                    class="btn btn-success btn-sm btn-icon-text mr-3"
                                                                                    data-toggle="modal"
                                                                                          ...
                                                                                          <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                      <div :key="index"
                                                                                                            ...
                                                                                                            <div>
                                                                                                                  <label
                                                                                                                        for="formGroupExampleInput">idT</label>
                                                                                                                  <input type="text"
                                                                                                                        class="form-control"
                                                                                                                        v-model="tt.idT"
                                                                                                                        id="formGroupExampleInput"
                                                                              ...
                                                                              <button type="button" @click="showTT(tt.idV)"
...
export default {
      ...
      mounted() {
            ...
            axios.get('http://localhost:3000/api/vetour/')
                  .then((response) => {
      ...
      methods: {
            ...
            chinhsua(idV) {
                  axios.get('http://localhost:3000/api/vetour/' + idV)
                        .then((response) => {
            ...
            update() {
                  ...
                  axios.put('http://localhost:3000/api/vetour/' + this.LTdon[0].idV, {
                        "nguoilon": this.LTdon[0].nguoilon,
                        "tre10": this.LTdon[0].tre10,
                        "idT": this.LTdon[0].idT,
                        "soluong": this.LTdon[0].soluong,
                  })
                        .then((response) => {
            ...
            addDD() {
                  ...
                  axios.post('http://localhost:3000/api/vetour/', {
                        "nguoilon": this.LTdon[0].nguoilon,
                        "tre10": this.LTdon[0].tre10,
                        "idT": this.LTdon[0].idT,
                        "soluong": this.LTdon[0].soluong,
            ...
            deleteLT() {
                  axios.delete('http://localhost:3000/api/vetour/' + this.idLTdelete)
                        .then((response) => {
                              // this.LTdon = response.data;
                              console.log('delete')
                        })
