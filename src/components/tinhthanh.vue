      ...
      <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                  <div class="content-wrapper">
                        <div class="row">
                              <h3 class="col-6">Danh sách tỉnh thành</h3>
                              <div class="col-6">
                                    <button :key="index" v-for="(tt, index) in tongLT" type="button"
                                          class="btn btn-outline-primary btn-fw">Tổng tỉnh thành {{ tt.tong }}</button>
                              </div>
                              <div>
                                                            ...
                                                            <div :key="index" v-for="(tt, index) in themLT ">
                                                                  ...
                                                                  <div>
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                              v-model="tt.tenTinh" id="formGroupExampleInput"
                                                                              placeholder="">
                                                                  </div>
                                                            </div>
                                                      </div>
                                                            ...
                                                            <tr :key="index" v-for="(tt, index) in dsLT ">
                                                                  ...
                                                                  <td>
                                                                        <div class="d-flex align-items-center">
                                                                              ...
                                                                              <button type="button" @click="showTT(tt.idTinh)"
...
export default {
      ...
      mounted() {
            ...
            axios.get('http://localhost:3000/api/lienhe/tinhthanh/')
                  .then((response) => {
            ...
            axios.get('http://localhost:3000/api/lienhe/tinhthanh/tongtinh/')
                  .then((response) => {
      ...
      methods: {
            ...
            chinhsua(idTinh) {
                  axios.get('http://localhost:3000/api/lienhe/tinh/' + idTinh)
                        .then((response) => {
            ...
            update() {
                  ...
                  axios.put('http://localhost:3000/api/lienhe/tinh/' + this.LTdon[0].idTinh, {
                        "tenTinh": this.LTdon[0].tenTinh,
                  })
                        .then((response) => {
            ...
            addDD() {
                  ...
                  axios.post('http://localhost:3000/api/lienhe/tinh', {
                        "tenTinh": this.themLT[0].tenTinh,
                  })
                        .then((response) => {
            ...
            deleteLT() {
                  axios.delete('http://localhost:3000/api/lienhe/tinh/' + this.idLTdelete)
                        .then((response) => {
                              // this.LTdon = response.data;
                              console.log('delete')
                        })
