...
export default {
      ...
      methods: {
            ...
            chinhsua(idTNB) {
                  axios.get('http://localhost:3000/api/tour/updateTNB/' + idTNB)
                        .then((response) => {
            ...
            update() {
                  ...
                  axios.put('http://localhost:3000/api/tour/updateTNB/' + this.LTdon[0].idTNB, {
